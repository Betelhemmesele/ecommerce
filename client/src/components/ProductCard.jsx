    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        ...
        <div className="card-actions justify-between">
          ...
          <button onClick={()=>{handleDelete(id)}} className="flex items-center justify-center bg-white border border-gray-200 rounded-sm shadow-sm font-medium text-red-800 px-5 py-2.5 hover:bg-gray-100 hover:text-gray-600 hover:shadow-md active:bg-gray-200 active:text-gray-600">
            Delete
          </button>
        </div>
      </div>
